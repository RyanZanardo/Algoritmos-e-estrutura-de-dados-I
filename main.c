...
void cadastrar_produto(int matriz[][6], int *linha_atual);
void listar_produtos(int matriz[][6], int linha_atual);
void buscar_codigo(int matriz[][6], int linha_atual);
void buscar_material(int matriz[][6], int linha_atual);
void imprimir_relatorio(int matriz[][6], int linha_atual);
...
void cadastrar_produto(int matriz[][6], int *linha_atual)
{
    ...
    scanf("%d", &matriz[*linha_atual][0]);

    printf("Digite o tipo do produto: ");
    scanf("%d", &matriz[*linha_atual][1]);

    printf("Digite o material do produto: ");
    scanf("%d", &matriz[*linha_atual][2]);

    printf("Digite o estoque do produto: ");
    scanf("%d", &matriz[*linha_atual][3]);

    printf("Digite a cor do produto: ");
    scanf("%d", &matriz[*linha_atual][4]);


    printf("Digite o preco do produto: ");
    scanf("%d", &matriz[*linha_atual][5]);
...
void buscar_codigo(int matriz[][6], int linha_atual)
{
    ...
    for (int i = 0; i < linha_atual; i++)
    {
        for (int j = 0; j < 6; j++)
        {
            ...
            {
                printf("O codigo : %d | O preco do produto : %d | A cor : %d | O material: %d",codigo,matriz[i][5],matriz[i][4],matriz[i][2]);
                return;
            }
        }
    }
